...
class LaporanController extends Controller
{
    ...
    {
        $pemesanan = Pemesanan::with('tempat', 'penumpang')->orderBy('created_at', 'desc')->get();
    ...
    {
        $data = Pemesanan::with('tempat.tiket.category', 'penumpang')->where('kode', $id)->first();
        if ($data) {
    ...
    public function pembayaran($id)
    {
        ...
        return redirect()->back()->with('success', 'Verifikasi Ticket Success!');
    }

    public function history()
    {
        $pemesanan = Pemesanan::with('tempat.tiket')->where('penumpang_id', Auth::user()->id)->orderBy('created_at', 'desc')->get();
