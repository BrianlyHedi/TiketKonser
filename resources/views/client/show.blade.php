                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <small class="text-muted">{{ $data['tiket'] }} ({{ $data['kode'] }})</small>
                      </div>
                  ...
                  <div class="card o-hidden border-0 shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto text-right">
                          <div class="h5 mb-0 font-weight-bold text-success">Rp. {{ number_format($data['harga'], 0, ',', '.') }}</div>
                          <small class="text-muted">/Orang</small>
                          @if ($data['kursi'] < 50)
                            <p class="text-success" style="margin: 0;"><small>{{ $data['kursi'] }} Kursi Tersedia</small></p>
                          @endif
                        </div>
                      </div>
                    </div>
          ...
          <div class="col-12 mb-4">
              <div class="card o-hidden border-0 shadow h-100 py-2">
                <div class="card-body text-center">
                  ...
                  <a href="{{ url('/') }}" class="btn btn-success" style="font-size: 16px; border-radius: 10rem;">
                    Ubah Pencarian
                  </a>
                </div>
              </div>
