...
<head>
  ...
  <title>Agen X - @yield('title')</title>
...
<body id="page-top">
  ...
  @else
    @if (Auth::user()->level == 'Admin')
          ...
          <footer class="sticky-footer bg-white">
            <div class="container my-auto">
              <div class="copyright text-center my-auto">
                <span>
                  With <i class="fas fa-heart"></i> - 2023
                </span>
              </div>
            </div>
          </footer>
      ...
      <!-- End of Page Wrapper -->
    @else
      <div class="bg-gradient-success" style="height: 160px; border-bottom-left-radius: 50% 20px; border-bottom-right-radius: 50% 20px;">
        <nav class="navbar navbar-expand navbar-light topbar mb-4">
          <div class="container">
            <a class="title" href="{{ url('/') }}">
              <div class="title-icon rotate-n-15">
              </div>
              <div class="title-text mx-3">Agen X</div>
            </a>
            <!-- Topbar Navbar -->
