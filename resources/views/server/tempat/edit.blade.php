...
@section('content')
  <div class="card shadow mb-4 mt-2">
    <form action="{{ route('tempat.store') }}" method="POST">
      @csrf
      <div class="card-body">
        <input type="hidden" name="id" value="{{ $tempat->id }}">
        ...
        <div class="form-group">
          <label for="tiket_id">Tiket</label><br>
          <select
      ...
      <div class="card-footer">
        <a href="{{ route('tempat.index') }}" class="btn btn-warning mr-2">Kembali</a>
